...
<body class="bg-info-subtle">
    ...
    <div class="container d-flex justify-content-center align-items-center">
        ...
        ?>
       <div class="card mt-5">
        <h5 class="card-header">Perfil paciente</h5>
        <div class="card-body">
            ...
            <p class="card-text"><b>Informacion medica:</b> <?php echo $row['informacion_medica']; ?></p>
            <a href="listaPacientes.php" class="btn btn-danger">Volver</a>
        </div>
       </div>
            <?php
        }else{
