    ...
    <div class="container mt-4">
        <h1>Lista calles</h1>
         ...
         <div class="d-flex justify-content-start mb-3">
            <a href="registroCalle.php" class="btn btn-primary">Registrar calle</a>
        </div>

        <!-- Buscador -->
        <div class="d-flex justify-content-end mb-3">
            <form action="buscarCalles.php" method="get">
                <label for="" class="form-label">Buscar por calle</label>
