...
<html lang="en">
  ...
  <body>
    ...
    ?>
      <form action="actualizarPais.php" method="post" style="width: 20rem;" class="bg-white p-3 rounded-2" id="loginForm">
      <h3>Actualizar pais</h3>
            <input type="hidden" id="id" name="id" value="<?php echo $row['id_pais']; ?>">
            <div class="mb-3">
                <label for="pais" class="form-label">Pais:</label>
                <input type="text" class="form-control" id="pais" name="pais" aria-describedby="emailHelp" value="<?php echo $row['nombre_pais']; ?>">
              </div>
              <button type="submit" class="btn btn-primary">Editar</button>
              <a href="listaPaises.php" class="btn btn-danger">Volver atras</a>
        </form>
        <?php
      }else{
