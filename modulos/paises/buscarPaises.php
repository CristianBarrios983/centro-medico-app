...
if (isset($_GET['busqueda'])) {
  ...
  if (empty($busqueda)) {
    ...
    <head>
        ...
        <title>Busqueda de paises</title>
    ...
    <body>
        <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Por favor, ingresa el nombre del pais para realizar la búsqueda.</h6>
                    <a href="listaPaises.php" class="btn btn-primary text-center">Volver</a>
                </div>
            </div>
        </div>
...
<?php    
    ...
    WHERE nombre_pais LIKE '%$busqueda%'";
    ...
    <body>
        <div class="container mt-4">
            ...
            <a href="listaPaises.php" class="btn btn-warning">Volver atras</a>
