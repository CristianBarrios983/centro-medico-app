    ...
    <div class="container mt-4">
        <h1>Lista provincias</h1>
         ...
         <div class="d-flex justify-content-start mb-3">
            <a href="registroProvincia.php" class="btn btn-primary">Registrar provincia</a>
        </div>

        <!-- Buscador -->
        <div class="d-flex justify-content-end mb-3">
            <form action="buscarProvincias.php" method="get">
                <label for="" class="form-label">Buscar por provincia</label>
