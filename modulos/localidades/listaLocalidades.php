...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-4">
        <h1>Lista localidades</h1>
         <!-- Botón de registro -->
         <div class="d-flex justify-content-start mb-3">
            <a href="registroLocalidad.php" class="btn btn-primary">Registrar localidad</a>
        </div>

        <!-- Buscador -->
        <div class="d-flex justify-content-end mb-3">
            <form action="buscarLocalidades.php" method="get">
                <label for="" class="form-label">Buscar por localidad</label>
