...
<div class="container d-flex justify-content-center align-items-center mt-5 mb-5">
        <form action="recibeDatosLocalidad.php" method="post" style="width: 20rem;" class="bg-white p-3 rounded-2" id="registerForm">
        <?php
            ...
            <div class="mb-3">
              ...
              <a href="listaLocalidades.php" class="btn btn-success">Atras</a>
        </form>
    </div>
