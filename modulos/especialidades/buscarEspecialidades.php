  ...
  if (empty($busqueda)) {
    ...
    <body>
        <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Por favor, ingresa el nombre de la especialidad para realizar la búsqueda.</h6>
                    <a href="listaEspecialidades.php" class="btn btn-primary text-center">Volver</a>
                </div>
            </div>
        </div>
...
<?php    
    ...
    WHERE nombre_especialidad LIKE '%$busqueda%'";
    ...
    <body>
        <div class="container mt-4">
            ...
            <a href="listaEspecialidades.php" class="btn btn-warning">Volver atras</a>
